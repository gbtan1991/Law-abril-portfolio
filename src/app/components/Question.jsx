...
const Question = () => {
  return (
    <div>
      <div className='max-w-[75rem] m-auto flex items-center justify-between py-10'>
              <div className='w-[65%] flex flex-col gap-7 items-start'>
              ...
              <div className='w-[35%] flex justify-center'>
                  <Image alt='call now' src={callNow} className='rounded-bl-3xl'/>
              </div>
        </div>
    </div>
