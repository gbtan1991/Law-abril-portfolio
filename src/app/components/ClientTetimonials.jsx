      ...
      <div className='flex justify-between gap-5'>
          <div className='flex flex-col justify-center w-[50%] items-center gap-10'>
            <div className='bg-white flex flex-col shadow-chatbox rounded-lg px-3 py-5 text-center h-[12rem] justify-center relative 
              ...
              <p className='text-sm text-gray-400'>We had an incredible experience working with Landify and were impressed they made such a big difference in only three weeks. Our team is so grateful for the wonderful improvements they made and their ability to get familiar with the concept so quickly.</p>
            </div>
          ...
          <div className='flex flex-col justify-center w-[50%] items-center gap-10'>
            <div className='bg-white flex flex-col shadow-chatbox rounded-lg px-3 py-5 text-center h-[12rem] justify-center relative 
              ...
              <p className='text-sm text-gray-400'>Fermin Apps has collaborated with Landify team for several projects such as Photo Sharing Apps and Custom Social Networking Apps. The experience has been pleasant, professional and exceeding our expectations. </p>
            </div>
            <div className='flex items-center gap-5'>
              <Image alt='testimonials-image' src={testimonialsImg}/>
                <div className='flex flex-col'>
